...
### Service-Specific
- [ ] Each tool tested with real-world operations (not just stubs)
- [ ] Bash: timeout kills runaway processes, truncation works for large output
- [ ] Code: real Ruby code executes, stdout/stderr captured, errors handled
